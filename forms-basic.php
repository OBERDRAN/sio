...
<head>
    ...
    <title>SIO-Cadastro de Ocorrência</title>
                                        ...
                                        <div class="card-body">
											<div class="form-group">
                                                ...
                                                <input id="BoSim" name="BoSim" required placeholder = "Somente Números" type="number_format" class="form-control"
                                                    aria-required="true" aria-invalid="false" onblur="checkNumber(this.value);" value="" >
                                            </div>

                                            <div class="form-group">
                                                <label for="Envolvido" class="control-label mb-1">Nome do
                                                    envolvido</label>
                                                <input id="Envolvido" name="Envolvido" type="text" class="form-control"
                                                    aria-required="false" aria-invalid="false" placeholder = "Nome do Envolvido" value="">
                                            </div>
                                            <div class="form-group">
                                                <label for="Mae" class="control-label mb-1">Mãe do
                                                    envolvido</label>
                                                <input id="Mae" name="Mae" type="text" class="form-control"
                                                    aria-required="false" aria-invalid="false" placeholder = "Nome da Mãe do Envolvido" value="">
                                            </div>
                                            <div class="row form-group">
                                                <label for="TipoVitima" class="control-label mb-1">Tipo da Vítima</label>
                                                <div class="col-12 col-md-12">
                                                    <select name="TipoVitima" id="TipoVitima" class="form-control">
                                            ...
                                            <div class="form-group has-success">
                                                <label for="Idade" class="control-label mb-1">Idade</label>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="DtNascimento" class="control-label mb-1">Data de
                                                            nascimento</label>
                                                        <input id="DtNascimento" name="DtNascimento" type="date"
                                                            class="form-control cc-exp" value="" required data-val="true"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="Sexo" class="control-label mb-1">Gênero</label>
                                                    </div>
                                                    <div class="col-12 ">
                                        ...
                                        <div class="card-body">
											<div class="form-group">
                                           	...
                                           	<div class="form-group">
                                                ...
                                                <input id="BoPrf" name="BoPrf" placeholder = "Número BoPrf" type="text" class="form-control"
						...
						<div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-group"><label for="PonRefLocAcid" class=" form-control-label">Ponto de
                                            Referência</label><input type="text" id="PonRefLocAcid" name="PonRefLocAcid" placeholder="Ponto de Referência do Acidente"
                                            class="form-control">
									</div>
                                    <!-- <div class="row form-group"> -->
                                    ...
                                    <div class="form-group"><label for="BairroAcid" class=" form-control-label">Bairro do Acidente</label><input type="text" id="BairroAcid" name="BairroAcid" placeholder="Bairro do Acidente"
											...
											<div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="DtAcidente" name="DtAcidente" type="date"
                                                            class="form-control cc-exp" required value="" data-val="true"
                                                            data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year"
                                                            placeholder="Ano/Mês/Dias" autocomplete="cc-exp">
												...
												<div class = "col-6">
													<div class="form-group">
														...
														<input id="DtObito" name="DtObito" type="date" class="form-control cc-exp" required
															value="" data-val="true"
															data-val-required="Please enter the card expiration"
															data-val-cc-exp="Please enter a valid month and year"
															placeholder="Ano/Mês/Dias" autocomplete="cc-exp">
												...
												<div class = "col-6">
													<div class="form-group">
														...
														<input id="HoraAcid" name="HoraAcid" type="time" class="form-control cc-exp" required
															...
															data-val-required="Please enter the card expiration"
															data-val-cc-exp="Please enter a valid month and year"
															placeholder="" autocomplete="cc-exp">
										...
										<div class="form-group">
                                            ...
                                            <input id="TipoDeVeicAcid" name="TipoDeVeicAcid" type="text" class="form-control cc-exp"
                                                value="" data-val="true"
                                                data-val-required="Please enter the card expiration"
                                                data-val-cc-exp="Please enter a valid month and year"
										...
										<div class="form-group">
                                            ...
                                            <textarea id="ObservAcidente" name="ObservAcidente" class = "form-control"
                                                placeholder="Qualquer informação relevante sobre o acidente" size = "300" ></textarea>
                                        </div>
